...
export const destinations: Record<string, Destination> = {
  ...
  "madrid": {
    ...
    highlights: [
      ...
      "Santiago Bernabéu: Real Madrid's home ground, more cathedral than stadium",
